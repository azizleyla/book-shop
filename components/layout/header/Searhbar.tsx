      ...
      <div className="flex items-center">
        <div className="flex items-center gap-16 ">
          <div className="w-16 h-16 md:w-20 md:h-20">
            <Image src={Img.logo} alt="logo" className="w-full h-full" />
          </div>
        ...
        <div className="ml-auto flex mt-5">
          <ul className="flex items-center gap-6 text-3xl text-[#FFAC56]  cursor-pointer">
            ...
            <li className="hidden lg:block relative">
              <SlBasket className="" />
              <span className="w-6 h-6  flex items-center justify-center absolute -top-3 -right-4 bg-[#0F3178] text-white rounded-full text-sm">3</span>
            </li>
